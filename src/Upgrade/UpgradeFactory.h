...
public:
    ...
    UpgradeFactory(ItemFactory* itemFactory): itemFactory(itemFactory) {
        ...
        prototypes[UpgradeId::Weapon].push_back(std::make_unique<UpgradeComponent>(UpgradeId::Weapon, std::make_unique<WeaponUpgrade>(WeaponStat::FiringRate, -4.0f), 2, "Atirar mais rápido"));
